...
if exist "C:\Program Files (x86)\Silhouette America\Silhouette Studio" (
	echo Silhouette Studio is already installed, skipping...
) else (
	echo Installing Silhouette Studio...
	msiexec /i "\\wcstech\installs\Sihouette\32bit\Silhouette Studio.msi" /qn
)

if exist "C:\Program Files\Adobe\Adobe InDesign CC 2019" (
	echo Adobe InDesign CC 2019 is already installed, skipping...
) else (
	echo Installing Adobe InDesign CC 2019...
